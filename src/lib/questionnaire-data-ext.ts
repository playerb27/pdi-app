...
const SECTIONS_8_14: Section[] = [
  ...
  },
  {
    ...
    questions: [
      { id:'s9q1', type:'opts', label:'¿Usa lentes o tiene diagnóstico visual?', options:['No, visión normal','Miopía','Hipermetropía','Astigmatismo','Presbicia','Combinación de defectos'] },
      ...
      { id:'s9q5', type:'multiopt', label:'Síntomas visuales que presenta', options:['Visión borrosa frecuente','Destellos o fotopsias','Moscas volantes (miodesopsias)','Pérdida súbita de visión (aunque sea transitoria)','Visión doble','Dificultad para ver de noche','Reducción del campo visual periférico','Ninguno'] },
  ...
  },
  {
    ...
    questions: [
      ...
      { id:'s10q3', type:'multiopt', label:'Cambios en el cabello o cuero cabelludo', options:['Caída de cabello excesiva (más de 100 hebras/día)','Adelgazamiento generalizado del cabello','Pérdida en zonas específicas (calvicie)','Cambio de textura (muy seco o muy graso)','Caspa persistente','Ninguno'] },
  ...
  },
  {
    ...
    questions: [
      ...
      { id:'s11q1', type:'opts', label:'¿Tiene diagnóstico de enfermedad renal?', options:['No','Enfermedad renal crónica estadio 1-2','Enfermedad renal crónica estadio 3-4','Insuficiencia renal en diálisis','Cálculos renales recurrentes','Nefropatía por otra causa'] },
      ...
      { id:'s11q3', type:'opts', label:'¿Tiene diagnóstico de enfermedad respiratoria?', options:['No','Asma','EPOC (enfisema o bronquitis crónica)','Apnea del sueño','Bronquiectasias','Fibrosis pulmonar','Otro'] },
  ...
  },
  {
    ...
    questions: [
      ...
      { id:'s13q2', type:'multiopt', label:'Principales metas de salud que desea lograr', options:['Perder peso','Ganar músculo y mejorar composición corporal','Tener más energía','Dormir mejor','Reducir estrés y ansiedad','Mejorar marcadores de laboratorio','Controlar enfermedad crónica','Prevenir enfermedades futuras','Optimizar rendimiento cognitivo','Mejorar salud hormonal','Mejorar salud digestiva'] },
...
export const TOTAL_QUESTIONS = ALL_SECTIONS.reduce(
  (acc, s) => acc + s.questions.filter(q => q.id).length, 0
);
